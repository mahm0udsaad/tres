...
// ── trigger tuning ─────────────────────────────────────────────────────────────
const DWELL_MS = 8000; // reveal after ~8s of browsing if they haven't scrolled
const SCROLL_RATIO = 0.4; // …or once they scroll past ~40% of the page
const SCROLL_CAP_PX = 900; // …but never require more than this much scroll
    ...
    <>
      <div className="lm-stage" data-state={state} aria-hidden={state === "hidden"}>
        ...
        >
          ...
          <CupTrack />
          <span className="lm-bubble-cta">{CTA}</span>
